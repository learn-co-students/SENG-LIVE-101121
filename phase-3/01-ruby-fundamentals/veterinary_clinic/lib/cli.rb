...
#    console.log('welcome to phase-3')
#   menu([])
#}
# function menu(arr){
#     console.log(arr)
...
def menu(patients_arr)
    puts "Welecome to #{CLINIC_NAME}"
    puts "Pelase choose an option:"
    ...
    when "2"
        puts patients_arr.map{|p| p[:name]}
    when "0"
